...
64.1--69.8\%) and with 12200~MHz is 54.2\% (95\%~CI: 51.2--57.4\%),
...
6000~MHz is $S = 0.671$ (95\%~CI: 0.641--0.698), and at 12200~MHz is
$S = 0.542$ (95\%~CI: 0.512--0.574).  The $\chi^2$ test for H2 rejects
...
agreement is negligible: $\rho = 0.056$ ($p = 0.078$) for
...
this drops to 39.9\% at 6000~MHz and to 16.0\% at 12200~MHz.
...
mechanism behind the low cross-frequency agreement: at higher
