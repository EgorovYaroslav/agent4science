...
| Тег | Этап | Что сделано | Время |
|-----|------|-------------|-------|
| `snapshot_20250615_100000` | 1. Литература | Чтение PDF (Egorov 2025), web-поиск, gap analysis, LIT.md | ~2 ч |
| `snapshot_20250615_100001` | 2. Декомпозиция | M.0–M.9: обозначения, предположения, метрика, план сбора данных | ~30 мин |
| `snapshot_20250615_100002` | 3. Гипотезы | H1–H9: формулировка, метод проверки, порядок | ~20 мин |
| `snapshot_20250615_100003` | 4. ТЗ | TZ.md: требования, sweep-сетка, спецификация вывода | ~20 мин |
| `experiment-v1` | 5–6. Эксперимент | experiment.py + отладка ftp_client + сбор 1000 триплетов + 4 прогона по ~70 мин + фикс label mapping + стратификация по месяцам + 6 графиков | ~6–7 ч |
| `paper-v1` | 7. Статья | LaTeX: 8 секций, 6 figure, 17 refs, компиляция tectonic | ~1 ч |
| `readme-v2` | — | README.md: документация, clear.py, адаптация | ~30 мин |
